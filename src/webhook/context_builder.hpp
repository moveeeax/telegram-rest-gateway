...
drogon::Task<std::optional<WebhookEvent>> buildEvent(
    tgw::bridge::TdBridge& bridge, std::int32_t client_id, const td::td_api::message& msg,
    tgw::ws::DetectResult det, std::int64_t owner_id, std::string session_id,
    std::int32_t received_at, int chain_limit = 20);
