...
// WebhookRegistry синхронный (add/remove/list не ходят в сеть под локом — см. webhook_registry.hpp),
// поэтому, в отличие от message_routes/directory_routes, хендлерам не нужна TDLib-корутина.
